...
# 'foreach' loops below.
samfiles: \
 $(foreach id, $(testIDs1), $(samDir)/test1-40222594/test$(id)Aligned.out.sam) \
 $(foreach id, $(testIDs2), $(samDir)/test2-40220751/test$(id)Aligned.out.sam) \
...
# TODO(dlroxe): Strings like "test1-40222594" are repeated an awful lot below.
# Figure out some way to make the rules more compact and less repetitive.
...
$(bamDir)/%.sorted.bam : $(samDir)/test1-40222594/%.out.sam | $$(@D)
	 $(sam2bam)

$(bamDir)/%.sorted.bam : $(samDir)/test2-40220751/%.out.sam | $$(@D)
	 $(sam2bam)
