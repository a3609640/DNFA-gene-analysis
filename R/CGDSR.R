...
TCGA_ProfileData_RNAseq = function(genename, geneticprofile, caselist) {getProfileData(mycgds, genename, geneticprofile, caselist)}
SCD_TCGA_RNAseq = function(x) {TCGA_ProfileData_RNAseq('SCD', geneticprofile_RNAseq(x), caselist_RNAseq(x))}  
...
#  geom_violin(alpha = .5, trim=FALSE)+
  geom_boxplot(alpha = .01, width = .5, position = position_dodge(width = .9))+
  theme_bw()+
...
ggplot(BRAF.mutations.DNFA.RNAseq, 
       aes(x=BRAF.mutations, y=log2(SCD), color=BRAF.mutations)) + 
  geom_boxplot(alpha = .01, width = .5) +
...
ggplot(NRAS.mutations.DNFA.RNAseq, 
       aes(x=NRAS.mutations, y=log2(SCD), color=NRAS.mutations)) + 
  geom_boxplot(alpha = .01, width = .5) +
  # binaxis = "y" stack the dots along the y-axis and group them along x-axis
  geom_dotplot(binaxis = "y", binwidth = .1, stackdir = "center", fill= NA)
...
ggplot(AKT.mutations.DNFA.RNAseq, 
       aes(x=AKT.mutations, y=log2(SCD), color=AKT.mutations)) + 
  geom_boxplot(alpha = .01, width = .5) +
  # binaxis = "y" stack the dots along the y-axis and group them along x-axis
  geom_dotplot(binaxis = "y", binwidth = .1, stackdir = "center", fill= NA)
...
ggplot(TP53.mutations.DNFA.RNAseq, 
       aes(x=TP53.mutations, y=log2(SCD), color=TP53.mutations)) + 
  geom_boxplot(alpha = .01, width = .5) +
  # binaxis = "y" stack the dots along the y-axis and group them along x-axis
  geom_dotplot(binaxis = "y", binwidth = .1, stackdir = "center", fill= NA)
...
ggplot(BRAF.CNV.DNFA.RNAseq, 
       aes(x=BRAF.CNV, y=log2(SCD), color=BRAF.CNV)) + 
  geom_boxplot(alpha = .01, width = .5) +
  # binaxis = "y" stack the dots along the y-axis and group them along x-axis
  geom_dotplot(binaxis = "y", binwidth = .1, stackdir = "center", fill= NA) +
...
ggplot(BRAF.CNV.DNFA.RNAseq, 
       aes(x=BRAF.CNV, y=log2(BRAF), color=BRAF.CNV)) + 
  geom_boxplot(alpha = .01, width = .5) +
  # binaxis = "y" stack the dots along the y-axis and group them along x-axis
  geom_dotplot(binaxis = "y", binwidth = .1, stackdir = "center", fill= NA) +
  scale_x_discrete(breaks = c("-2", "-1",  "0",  "1", "2"), 
...
ggplot(NRAS.CNV.DNFA.RNAseq, 
       aes(x=NRAS.CNV, y=log2(SCD), color=NRAS.CNV)) + 
  geom_boxplot(alpha = .01, width = .5) +
  # binaxis = "y" stack the dots along the y-axis and group them along x-axis
  geom_dotplot(binaxis = "y", binwidth = .1, stackdir = "center", fill= NA) +
  scale_x_discrete(breaks = c("-2", "-1",  "0",  "1", "2"), 
...
ggplot(NRAS.CNV.DNFA.RNAseq, 
       aes(x=NRAS.CNV, y=log2(NRAS), color=NRAS.CNV)) + 
  geom_boxplot(alpha = .01, width = .5) +
  # binaxis = "y" stack the dots along the y-axis and group them along x-axis
  geom_dotplot(binaxis = "y", binwidth = .1, stackdir = "center", fill= NA) +
  scale_x_discrete(breaks = c("-2", "-1",  "0",  "1", "2"), 
...
ggplot(PTEN.CNV.DNFA.RNAseq, 
       aes(x=PTEN.CNV, y=log2(SCD), color=PTEN.CNV)) + 
  geom_boxplot(alpha = .01, width = .5) +
  # binaxis = "y" stack the dots along the y-axis and group them along x-axis
  geom_dotplot(binaxis = "y", binwidth = .1, stackdir = "center", fill= NA) +
  scale_x_discrete(breaks = c("-2", "-1",  "0",  "1", "2"), 
...
ggplot(PTEN.CNV.DNFA.RNAseq, 
       aes(x=PTEN.CNV, y=log2(PTEN), color=PTEN.CNV)) + 
  geom_boxplot(alpha = .01, width = .5) +
  # binaxis = "y" stack the dots along the y-axis and group them along x-axis
  geom_dotplot(binaxis = "y", binwidth = .1, stackdir = "center", fill= NA) +
  scale_x_discrete(breaks = c("-2", "-1",  "0",  "1", "2"), 
